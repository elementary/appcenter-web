...
# HTTPS doesn't work
componentsDataGz = URI.open("http://packages.elementary.io/appcenter/dists/xenial/main/dep11/Components-amd64.yml.gz")
...
YAML.load_stream(componentsData) do |doc|
  ...
  appFile.sub!('((title))', CGI.escapeHTML(doc['Name']['C']))
  appFile.sub!('((summary))', CGI.escapeHTML(doc['Summary']['C']))
  appFile.sub!('((dev))', CGI.escapeHTML(doc['DeveloperName']['C']))
